...
function trans() {
    ...
    async function translateText(text, targetLanguage) {
        ...
        let urlTest = "https://api.fanyi.baidu.com/api/trans/vip/translate?q=apple&from=en&to=zh&appid=2015063000000001&salt=1435660288&sign=f89f9594663708c1605f3d736d01d2d4";
        console.log(url);
